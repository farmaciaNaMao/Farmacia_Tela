      ...
      /*    areaInformacao.nome.innerHTML = pedidoCapturado.nome;
        ...
        "<div class='pedido-clicado'>" +
          ...
          "<div class='detal-pedido'>" +
              ...
              "<div class='detalhe-nome'>" + pedidoCapturado.nome + "</div>" +
              "<div class='detalhe-numero'>" + pedidoCapturado.numeroPedido + "</div>" +
          "</div>" +
          "<div class='second-detalhes-info '>" +
              "<div class='detalhe-hora'>" + pedidoCapturado.data +"</div>" +
          "<div class='detalhe-atend'>" + pedidoCapturado.atendente + "</div>" +
          "</div>" +
          "</div>" +
          "</div>"
